...
* **Hybrid Extraction Engine**: Combines robust deterministic date/time parsing with an LLM fallback to reliably pull hidden meetings, deadlines, and tasks from both Gmail and Slack.
* **Smart De-duplication**: Intelligently merges overlapping or duplicate event candidates to keep your calendar clean.
* **One-Click Event Review**: Extracted events are presented in a dedicated Event Review dialog, allowing you to confirm and add them to your schedule instantly.
...
* **AI Task Classification**: AI automatically categorizes incoming messages into actionable tasks (*Simple Reply Required*, *Auto Reply*, *Draft Generation*, *File Attachment Required*, or *Informational*).
* **AI Analysis Dialog**: A unified, heavily-styled interface that displays the message summary, a color-coded task classification badge, and read-only Recommended Actions highlighting the best next step.
...
* [x] Calendar Event & Task Extraction
* [x] Universal AI Smart Draft generation
* [x] Comprehensive AI Task Classification & Suggested Actions
